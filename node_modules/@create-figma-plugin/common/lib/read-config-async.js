...
export async function readConfigAsync() {
    ...
    const { api, build, containsWidget, editorType, enableProposedApi, enablePrivatePluginApi, id, name, main, ui, menu, parameters, parameterOnly, permissions, relaunchButtons, widgetApi } = config;
    return {
